...
<head>
  ...
  <meta name = "description" content = "Сайт создан с целью объединения людей увлеченных радио">
  <meta name = "keywords"  content = "радио,HAM radio,HAM,радиолюбители,спутники,WSPR">
  <meta name = "AUTHOR"    content = "R3KCA">
 
 <!-- заголовок -->
  <title> Объединение радиолюбителей </title>
...
<body>
	...
	<!--<div class = "menu"> -->
	<div class = "content">тестvbv
	 fgefger
	 ergУ этого термина существуют и другие значения, см. Текст (значения).
...
1	Признаки текста
1.1	Членимость
1.2	Смысловая цельность текста
2	Стили и типы текста
...
Основные статьи: Когерентность (лингвистика) и Когезия (лингвистика)
...
Минимальный текст, имеющий смысл, называется записью. Также может называться заметкой.
...
Текст // Литературная энциклопедия терминов и понятий / Под ред. А. Н. Николюкина. — Институт научной информации по общественным наукам РАН: Интелвак, 2001. — Стб. 1063—1064 — 1596 с. — ISBN 5-93264-026-Х.
...
[показать]⛭
Кодировки символов
Категории: ТекстПсихолингвистика
Навигация
...
Ещё 50
Править ссылки
Эта страница в последний раз была отредактирована 4 июля 2020 в 05:49.
